...
import { Sparkles, PartyPopper, Music, Flower2 } from "lucide-react";
    ...
    <div className="text-center space-y-10 max-w-2xl animate-reveal">
      ...
      <div className="fixed top-4 right-4 z-50">
        <div className="bg-card/90 backdrop-blur-sm rounded-2xl p-3 border border-border/50 shadow-xl">
          ...
          <iframe
            ...
            width="250"
            height="50"
            src="https://www.youtube.com/embed/Qe8fa4b5xNU?start=42&rel=0&autoplay=1&loop=1&playlist=Qe8fa4b5xNU  "
        ...
        <div className="space-y-6">
          ...
          <div className="border border-primary/40 rounded-xl p-6 bg-card/30 backdrop-blur-sm">
            <p className="text-sm md:text-base text-foreground/90 leading-relaxed flex flex-col gap-1">
              <span>
                Чиний инээмсэглэл өдөр бүрийг гэрэлтүүлж дулаахан болгодог.
              </span>
              <span>
                Зарим хүмүүс байдаг даа ... зүгээр л дэргэд нь байхад сэтгэл
                тайвширч, чимээгүйхэн амар болчихдог.
              </span>
              <span>
                Жижигхэн зүйлсийг ч анзаардаг, хүмүүсийн сэтгэл санааг
                тайвшруулж чаддаг хүн шүү.
              </span>
              <span>
                Амьдрал дээр зарим үгийг шууд хэлэх амаргүй байдаг. Тиймээс л
                энэ сайтыг хийсэн юм.
              </span>
              <span>
                Хариу шаардахгүй, юу ч нэхэхгүй ,зүгээр л чи үүнийг мэдрээсэй
                гэж.
              </span>
              <span>
                Амьдралд чинь өөр шиг чинь сэтгэлтэй хүмүүс олон тааралдаасай.
              </span>
              <span>Инээмсэглэл чинь хэзээ ч бүү алдраасай.</span>
              <span>
                Уншсанд баярлалаа. Энэ бүхэн зөвхөн сайн сайхны төлөө. Хариу
                бичих хэрэггүй ээ .
              </span>
            </p>
          </div>
      ...
      <div className="space-y-6 max-w-md mx-auto">
        ...
        <p className="text-xl md:text-2xl text-foreground leading-relaxed font-light">
          Би чамд энэ бяцхан бэлгийг зориулж байна.
          <span className="text-primary font-medium">
            {" "}
            харах бүртээ намайг санаасай{" "}
          </span>
          гэж хүслээ.
        </p>
